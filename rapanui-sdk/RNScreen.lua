...
function RNScreen:clear(layer)
  layer = layer or self.layer

  local partition, noname

  if type(layer) == "string" then
    noname, partition = self:getLayer(layer)
  else
    partition = layer:getPartition() or self.mainPartition
  end
